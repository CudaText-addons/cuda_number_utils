...
def dialog_insert_numbers():
    ...
    res = dlg_custom(_('Insert Numbers'), 600, 220, '\n'.join([]
      ...
      +[c1.join(['type=spinedit', 'ex0=-1000', 'ex1=1000000', 'ex2=1', 'val=1', 'pos=200,24,294,0'])]
      +[c1.join(['type=label', 'cap='+_('&Digits:'), 'pos=300,6,400,0'])]
      +[c1.join(['type=spinedit', 'ex0=1', 'ex1=20', 'ex2=1', 'val=1', 'pos=300,24,394,0'])]
      ...
      +[c1.join(['type=spinedit', 'ex0=1', 'ex1=2000000', 'ex2=1', 'val=4', 'en='+str(int(not use_sel)), 'pos=6,150,100,0'])]
